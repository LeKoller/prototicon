...
export default {
  ...
  setup() {
    ...
    async function follow() {
      await axios
        .post(
          `http://ec2-177-71-148-166.sa-east-1.compute.amazonaws.com/api/follow/${store.state.other.username}/`,
          {},
          config
        )
    ...
    async function getOtherFeed() {
      const contents = await axios
        .get(
          `http://ec2-177-71-148-166.sa-east-1.compute.amazonaws.com/api/contents/?author=${store.state.other.username}`,
          config
        )
        .then((response) => response.data)
    ...
    async function updateOther() {
      const other = await axios
        .get(
          `http://ec2-177-71-148-166.sa-east-1.compute.amazonaws.com/api/accounts/${store.state.other.username}/`,
          config
        )
        .then((response) => response.data)
        .then((data) => data);
